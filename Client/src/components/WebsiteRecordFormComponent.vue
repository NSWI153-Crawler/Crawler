...
async function handleSubmit() {
  if (formFields.creation) {
    await store.createRecord(formFields.url, formFields.regexp, formFields.periodicity, formFields.label, formFields.status, formFields.tags.split(/[,\s]+/))
  } else {
    await store.updateRecord(formFields.id, formFields.url, formFields.regexp, formFields.periodicity, formFields.label, formFields.status, formFields.tags.split(/[,\s]+/))
  }
  hideForm()
}
...
function showEditForm(id:string, label:string, url:string, regexp:string, tags:string, periodicity:number, status:boolean) {
